    ...
    <div class="col-12 col-sm-10 col-md-7 col-lg-5">
        <div class="card card-soft shadow-sm mb-3">
            <div class="card-body p-4 auth-simple-card">
                ...
                <form method="post" class="row g-3" novalidate data-auth-form="forgot-request">
                    ...
                    <div class="col-12">
                        ...
                        <input
                            ...
                            maxlength="12"
                        >
                        <div class="form-text" data-feedback="forgot-phone">Use your registered 11-digit mobile number.</div>
                    </div>
        ...
        <?php if ($resetPayload): ?>
            <div class="card card-soft shadow-sm">
                <div class="card-body p-4 auth-simple-card">
                    ...
                    <form method="post" class="row g-3" novalidate data-auth-form="forgot-reset">
                        <input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>">
                        <input type="hidden" name="action" value="verify_reset">
                        <div class="col-12">
                            <label class="form-label">Verification Code</label>
                            <input type="text" class="form-control" name="otp_code" maxlength="8" required placeholder="Enter code" inputmode="numeric" pattern="[0-9]*">
                            <div class="form-text" data-feedback="forgot-otp-code">Enter the verification code sent to your mobile number.</div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="form-text" data-feedback="forgot-new-password">Use at least 8 characters.</div>
                        </div>
                        <div class="col-12">
                            ...
                            <div class="form-text" data-feedback="forgot-confirm-password">Re-enter the same password.</div>
                        </div>
                        <div class="col-12 d-grid">
