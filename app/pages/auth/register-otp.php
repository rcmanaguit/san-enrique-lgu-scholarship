    ...
    <div class="col-12 col-sm-10 col-md-7 col-lg-5">
        <div class="card card-soft shadow-sm">
            <div class="card-body p-4 auth-simple-card">
                ...
                <form method="post" class="row g-3" novalidate data-auth-form="register-otp">
                    <input type="hidden" name="csrf_token" value="<?= e(csrf_token()) ?>">
                    <input type="hidden" name="action" value="verify_otp">
                    <div class="col-12">
                        <label class="form-label">Verification Code</label>
                        <input type="text" name="otp_code" class="form-control" maxlength="8" required placeholder="6-digit code" inputmode="numeric" pattern="[0-9]*">
                        <div class="form-text" data-feedback="register-otp-code">Enter the verification code sent to your mobile number.</div>
                    </div>
