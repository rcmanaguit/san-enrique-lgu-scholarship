...
CREATE TABLE IF NOT EXISTS application_periods (
    ...
    period_status ENUM('open','closed','completed') NOT NULL DEFAULT 'closed',
...
CREATE INDEX idx_application_periods_status ON application_periods(period_status, id);
...
CREATE INDEX idx_sms_logs_status_created ON sms_logs(delivery_status, created_at);
...
VALUES (
    ...
    '09123456789',
    '$2y$10$uoszoFgwEEAQKgHy.K96quqDFuabpoY1DKicqbNvCarmKpdso6L92',
    'active'
)
