...
if (db_ready()) {
    ...
    if (is_array($openPeriod)) {
        ...
        $currentSemesterLabel = 'No Open Period';
    }
    ...
    foreach ($statusTotals as $status => $total) {
        ...
        $statusChartLabels[] = application_status_label($status);
...
$pageHeaderSecondaryInfo = 'Today: <strong>' . number_format($todayApplications) . '</strong> new applications. Current period: <strong>' . e($currentSemesterLabel) . '</strong> with <strong>' . number_format($currentSemesterApplications) . '</strong> records.';
$pageHeaderActions = '';
...
<div class="row g-3 mb-4">
        ...
        <a href="applications.php?queue=under_review" class="text-reset text-decoration-none d-block h-100">
            <article class="card card-soft dashboard-stat-card tone-cyan h-100">
                <div class="card-body">
                    ...
                    <p class="small mb-1">Needs Review</p>
        ...
        <a href="applications.php?queue=under_review" class="text-reset text-decoration-none d-block h-100">
            <article class="card card-soft dashboard-stat-card tone-amber h-100">
                <div class="card-body">
                    ...
                    <p class="small mb-1">Needs Resubmission</p>
        ...
        <a href="applications.php?queue=for_interview" class="text-reset text-decoration-none d-block h-100">
            <article class="card card-soft dashboard-stat-card tone-blue h-100">
                <div class="card-body">
                    ...
                    <p class="small mb-1">Interview to Schedule</p>
    ...
    <div class="col-6 col-lg-3 col-xl">
        <a href="applications.php?queue=for_soa" class="text-reset text-decoration-none d-block h-100">
            <article class="card card-soft dashboard-stat-card tone-cyan h-100">
                <div class="card-body">
                    <span class="dashboard-stat-icon"><i class="fa-solid fa-file-invoice"></i></span>
        ...
        <a href="applications.php?queue=approved_for_release" class="text-reset text-decoration-none d-block h-100">
            <article class="card card-soft dashboard-stat-card tone-amber h-100">
                <div class="card-body">
                    ...
                    <p class="small mb-1">Ready for Payout</p>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <?php foreach ($recentApplications as $row): ?>
                        <tr>
                            ...
                            <td><span class="badge <?= status_badge_class((string) ($row['status'] ?? '')) ?>"><?= e(strtoupper(application_status_label((string) ($row['status'] ?? ''))) ) ?></span></td>
